...
const PortfolioPage: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A responsive weather application that displays current weather conditions, forecasts, and weather maps using external APIs.",
      image:
        "https://via.placeholder.com/400x250/48c9b0/ffffff?text=Weather+App",
      technologies: ["JavaScript", "API Integration", "Chart.js", "Bootstrap"],
      category: "Frontend",
      demoUrl: "https://demo-weather.com",
      githubUrl: "https://github.com/gjorgji/weather-dashboard",
      featured: false,
    },
    {
      id: 4,
      title: "Blog CMS",
      description:
        "A content management system for bloggers with rich text editor, category management, and SEO optimization features.",
      image: "https://via.placeholder.com/400x250/f39c12/ffffff?text=Blog+CMS",
      technologies: ["PHP", "Laravel", "MySQL", "TinyMCE"],
      category: "Backend",
      demoUrl: "https://demo-blog.com",
      githubUrl: "https://github.com/gjorgji/blog-cms",
      featured: false,
    },
    {
      id: 5,
      ...
      description:
        "A modern restaurant website with online menu, reservation system, and contact forms. Fully responsive design with smooth animations.",
      image:
        "https://via.placeholder.com/400x250/e74c3c/ffffff?text=Restaurant+Site",
      technologies: ["React", "Sass", "Framer Motion", "Netlify"],
      category: "Frontend",
      demoUrl: "https://demo-restaurant.com",
      githubUrl: "https://github.com/gjorgji/restaurant-website",
      featured: false,
    },
    {
      id: 6,
        ...
        <Row>
          <Col>
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h2 className="h3 text-warning mb-0 font-poppins">
                <svg
                  width="24"
                  height="24"
                  fill="currentColor"
                ...
                <Col key={project.id} lg={6} xl={4}>
                  <Card className="h-100 bg-dark border-secondary project-card">
                    ...
                    <Card.Body className="p-4 d-flex flex-column">
                      ...
                      <Card.Title className="text-light font-poppins h6 mb-3">
                        {project.title}
                      </Card.Title>
                      <Card.Text className="text-light font-inter small mb-3 flex-grow-1">
                        {project.description}
                      </Card.Text>
                      <div className="mb-3">
                        <div className="d-flex flex-wrap gap-1">
