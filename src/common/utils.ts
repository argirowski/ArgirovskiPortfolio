...
export const projects = [
  ...
  },
  {
    ...
    title: "Next Blog",
    description:
      "A full-stack blogging platform built with Next.js 16 and React (TypeScript) using the App Router, Server Components, and Server Actions. Features NextAuth authentication, SQLite persistence, ISR-backed public pages with SEO, post CRUD for signed-in users, and Docker deployment.",
    technologies: [
      "Next.js",
      "React (TypeScript)",
      "NextAuth",
